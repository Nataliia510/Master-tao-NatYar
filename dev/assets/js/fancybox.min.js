!function(t, e) {
    ...
    class k extends g {
        ...
        onClick(t) {
            ...
            1 == this.clicks && (this.clickTimer = setTimeout((()=>{
                ...
                !t.defaultPrevented && c && l(c)) : (this.emit("dblClick", t),
        ...
        onPointerDown(t, e, i) {
            ...
            if (!i.length) {
                ...
                if (["A", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].includes(e.nodeName) || e.closest("[contenteditable]") || e.closest("[data-selectable]") || e.closest("[data-panzoom-change]") || e.closest("[data-panzoom-action]"))
                    return !1;
        ...
        applyChange({panX: t=0, panY: i=0, scale: n=1, angle: s=0, originX: o=-this.current.e, originY: a=-this.current.f, friction: r=this.option("friction"), flipX: l=!1, flipY: c=!1, ignoreBounds: h=!1, bounce: d=this.option("bounce")}) {
            ...
            c && (g = g.scale(1, -1));
            for (const t of v)
                "e" !== t && "f" !== t && (g[t] > this.minScale + 1e-5 || g[t] < this.minScale - 1e-5) ? this.target[t] = g[t] : this.target[t] = e(g[t], T);
            (this.targetScale < this.scale || Math.abs(n - 1) > .1 || this.panMode === O || !1 === d) && !h && this.clampTargetBounds(),
            this.isResting || (this.state = b.Panning,
            this.requestTick())
        }
        stop(t=!1) {
        ...
        zoomTo(t=1, {friction: e="auto", originX: i=0, originY: n=0, event: s}={}) {
            ...
            s) {
                const t = this.content.getBoundingClientRect()
                  , e = s.clientX || 0
                  , o = s.clientY || 0;
                i = e - t.left - .5 * t.width,
                n = o - t.top - .5 * t.height
            }
    ...
    class G extends g {
        ...
        createPages() {
            ...
            for (const e of this.slides)
                (!t.length || o + e.dim > i || a === n) && (t.push(B()),
                s = t.length - 1,
                o = 0,
                a = 0),
                t[s].slides.push(e),
        ...
        getSlideMetrics(t) {
            ...
            s += parseFloat(r.paddingRight) || 0) : (s += parseFloat(r.paddingTop) || 0,
        ...
        transitionTo(t=0, i=this.option("transition")) {
            ...
            if (!s || !n[o] || n.length < 2 || Math.abs(n[this.page].slides[0].dim - this.viewportDim) > 1)
                return !1;
            ...
            let d = c.el
              , u = h.el;
            l || "slide" === i || (i = "fadeFast",
            d = null);
            const p = this.isRTL ? "next" : "prev"
              , f = this.isRTL ? "prev" : "next";
            return d && (this.inTransition.add(c.index),
            c.transition = i,
        ...
        markSelectedSlides() {
            ...
            if (e)
                for (const i of this.slides)
                    ...
                    this.pages[this.page].slides.includes(i) ? (i.el.classList.contains(e) || (P(i.el, e),
                    this.emit("selectSlide", i)),
                    i.el.removeAttribute(t)) : (i.el.classList.contains(e) && (S(i.el, e),
        ...
        onDecel(t, e=0, i=0) {
            ...
            h ? this.onChange(m) : (Math.abs(c) > 5 ? (a[d].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (d = g),
            d = n && s ? c < 0 ? d - 1 : d + 1 : c < 0 ? d + 1 : d - 1) : d = g,
            this.slideTo(d, {
                transition: !1,
        ...
        slideTo(t=0, {friction: e=this.option("friction"), transition: i=this.option("transition")}={}) {
            ...
            d *= c,
            Math.abs(r.target[n] - d) < .1 || (r.panTo({
                x: s ? d : 0,
                y: s ? 0 : d,
                friction: e
            }),
    ...
    class ot extends N {
        ...
        static startFromUrl() {
            ...
            jt.getInstance() || !1 === jt.defaults.Hash)
                return;
    ...
    class rt extends N {
            ...
            o && "image" === a && "string" == typeof s && this.setContent(i, s).then((t=>{
                ...
                if (a && r) {
                    ...
                    let a = n.optionFor(i, "showClass") || void 0
                      , r = !0;
                    n.isOpeningSlide(i) && ("full" === e ? t.zoomToFull(o) : "cover" === e ? t.zoomToCover(o) : "max" === e ? t.zoomToMax(o) : r = !1,
                    t.stop("current")),
        ...
        setContent(t, e) {
            return new Promise(((i,n)=>{
                ...
                c && E(c) || (c = document.createElement("img"),
                c instanceof HTMLImageElement && (c.src = e || "",
                ...
                t.panzoom = new k(l,p({}, this.option("Panzoom") || {}, {
                    ...
                    click: (e,i)=>{
                        var n, s;
                        if (r.isCompact || r.isClosing())
                            return !1;
                        if (t.index !== (null === (n = r.getSlide()) || void 0 === n ? void 0 : n.index))
                            return !1;
        ...
        getZoomInfo(t) {
            ...
            if (!i || !n || !s || !o || U(s) < 3 || !this.optionFor(t, "zoom") || this.instance.state === it.Destroy)
                return !1;
    ...
    class dt extends N {
        ...
        setAspectRatio(t) {
            ...
            if (!(i && s && n && 1 !== n && t.type && ["video", "youtube", "vimeo", "html5video"].includes(t.type)))
                return;
            const o = s.width
              , a = s.height;
    ...
    class ut extends N {
        ...
        set() {
            ...
            this.state = "play",
            P(this.instance.container, "has-autoplay");
    ...
    class vt extends N {
        ...
        onInit() {
            ...
            this.option("showOnStart") || (this.ref.state = mt.Hidden,
            this.hidden = !0))
        }
        onResize() {
            var t;
    ...
    class St extends N {
        ...
        createEl(t) {
            ...
            if ("toggleFS" === t)
                return null;
            if ("fullscreen" === t && !this.instance.fsAPI)
                return null;
            let n = null;
            ...
            if ("slideshow" === t) {
                if (!(null === (e = this.instance.carousel) || void 0 === e ? void 0 : e.plugins.Autoplay) || o < 2)
                    return null
            }
            if (void 0 !== yt[t]) {
                const e = yt[t];
    ...
    class jt extends g {
        ...
        initLayout() {
            ...
            kt && It || (kt = document.createElement("span"),
        ...
        initCarousel(t) {
            ...
            s.on(["refresh", "change"], (t=>{
                ...
                for (const t of e.querySelectorAll("[data-fancybox-download]")) {
                    ...
                    t.setAttribute("target", "_blank")) : (t.setAttribute("disabled", ""),
                    t.setAttribute("tabindex", "-1"),
        ...
        attachEvents() {
            ...
            e && (e.addEventListener("scroll", this.onResize),
        ...
        onClick(t) {
            ...
            if (Rt() && o && n.contains(o))
                return;
            const a = t.composedPath()[0];
            if (a === (null === (e = this.carousel) || void 0 === e ? void 0 : e.container))
                return;
            ...
            if (a.closest(".fancybox__content")) {
                ...
                a.closest(".fancybox__carousel") && !a.matches(Q) && (r = this.option("backdropClick"));
        ...
        onWheel(t) {
            const e = this.option("wheel", t)
              ...
              , o = Date.now();
            this.pwt && o - this.pwt < 300 ? i && t.preventDefault() : (this.pwt = o,
            this.emit("wheel", t),
            t.defaultPrevented || ("close" === e ? (t.preventDefault(),
            this.close(t)) : "slide" === e && (t.preventDefault(),
            this[s > 0 ? "prev" : "next"]())))
        }
        onKeydown(t) {
            if (!this.isTopmost())
        ...
        focus(t) {
            ...
            for (let t of r) {
                ...
                !t.hasAttribute("autoFocus") && c || (c = t)) : (t.dataset.origTabindex = void 0 === t.dataset.origTabindex ? t.getAttribute("tabindex") || void 0 : t.dataset.origTabindex,
                t.tabIndex = -1)
            }
            let h = null;
            t ? (!n || l.indexOf(n) < 0) && (h = c || s,
            l.length && (i === It ? h = l[0] : this.lastFocus !== s && i !== kt || (h = l[l.length - 1]))) : h = o && "image" === o.type ? s : c || s,
            h && tt(h),
        ...
        hideLoading(t) {
            ...
            if (!e)
                return;
            const i = t.spinnerEl;
            this.isClosing() ? null == i || i.remove() : (S(e, Lt),
        ...
        static unbind(t, e) {
            ...
            s && n && s.delete(n),
            n && s || (jt.openers.delete(i),
            i.removeEventListener("click", jt.fromEvent))
        }
        static destroy() {
            let t;
            for (; t = jt.getInstance(); )
                t.destroy();
        ...
        static fromEvent(t) {
            ...
            return u && u.options.trigger && r.indexOf(u.options.trigger) > -1 ? void 0 : (e && (l.startIndex = r.indexOf(e)),
            jt.fromNodes(r, l))
        }
        ...
        static fromNodes(t, e) {
            ...
            for (const n of t) {
                ...
                o && (r = o.currentSrc || o.src || void 0,
                !r && o.dataset && (r = o.dataset.lazySrc || o.dataset.src || void 0));
                const l = {
                    src: s,
                    triggerEl: n,
                    thumbEl: o,
